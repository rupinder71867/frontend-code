  ...
  <>
   <Modal show={show} onHide={handleClose} className="modal-lg">
    <Modal.Header closeButton>
     <Modal.Title>Add Table Block</Modal.Title>
    </Modal.Header>
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
     ...
     <Modal.Body>
      ...
      <Row className='mt-2'>
       <Col>
        <Form.Check type="checkbox" id="checkbox" label="Online Reservation" onChange={handleChange} />
       </Col>
       <Col>
        <Form.Check type="checkbox" id="checkbox" label="In-House Reservation" onChange={handleChange} />
       </Col>
      </Row>
      ...
      <Row className='mt-2'>
       ...
       <Col>
        ...
        <Form.Control required type="time" name="stime" onChange={handleChange} />
       </Col>
      </Row>
      <Row className="mt-2">
       <Col>
     ...
     <Modal.Footer>
      <Form.Group>
       <Row>
        ...
        <Col>
         <Button type="submit">Block Selected Table</Button>
        </Col>
       </Row>
      </Form.Group>
     </Modal.Footer>
