            ...
            <Row>
                <Col md={3} className="border-end bg-light sidebar1 ">
                    <Row className="gap-2 justify-content-center">
                        <NavLink className="btn menuBg py-3">Reservation Widget</NavLink>
                        <NavLink className="btn menuBg py-3">Googele Online</NavLink>
                        <NavLink className="btn menuBg py-3">Waitlist</NavLink>
                        ...
                        <NavLink className="menuBg btn py-3 addShifts">Add new inventory</NavLink>
                    </Row>
                        ...
                        <Col className="px-4">
                            <Row className="py-3">
                                <Col className="d-flex justify-content-center">
                                    <div className="txt"> Online inventory</div>
                                </Col>
