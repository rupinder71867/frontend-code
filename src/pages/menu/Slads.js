...
const Slads = (props) => {
 ...
 return (
  <>
   {show ? <AddStarterModal title='Slads' show={show} handleStarters={handleStarters} handleShow={handleShow} handleClose={handleClose} /> : ''}
   <Row className="border-bottom">
    <Col style={{ fontWeight: 600 }}>
     Slads
    </Col>
    <Col align="Right">
     <Button variant="primary" onClick={handleShow}>Add Slads</Button>
    </Col>
   </Row>
   <Row className='mt-2'>
    <Col>
